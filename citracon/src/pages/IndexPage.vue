<template>
  <q-page
    class="text-slate-800 min-h-screen font-sans selection:bg-[#d21d1d] selection:text-white"
    style="padding-top: 0 !important"
  >
    <!-- Full-Bleed Hero Banner — bleeds under the navbar -->
    <div
      class="relative overflow-hidden w-full"
      style="height: 100svh; min-height: 600px; margin-top: 0"
    >
      <q-carousel
        v-model="activeSlide"
        animated
      ...
      >
        ...
        >
          ...
          <div
            class="absolute inset-0 bg-gradient-to-b from-black/80 via-black/55 to-black/80 z-10"
          ></div>

          <!-- Content Overlay (Centered text, no card) -->
          <div
            class="absolute inset-0 z-20 flex items-center justify-center text-center px-4 pt-[72px]"
          >
            <div class="max-w-4xl">
              <div
                class="inline-block bg-white border border-slate-200 px-4 py-1.5 rounded-full shadow-sm mb-4"
              >
              ...
              <h1
                class="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white mb-4 uppercase leading-none"
                v-html="slide.title"
              ></h1>
              <p
                class="text-xs md:text-sm lg:text-base font-medium text-slate-200 mb-8 max-w-2xl mx-auto leading-relaxed"
              >
                {{ slide.desc }}
              </p>
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8 py-12">
      ...
      <div id="profil-perusahaan" v-reveal class="max-w-4xl mx-auto text-center py-8 mb-16 reveal">
        <div
          class="inline-block px-4 py-1.5 bg-[#d21d1d]/10 text-[#d21d1d] text-xs font-bold uppercase tracking-wider rounded-full mb-4"
        >
          Profil Perusahaan
        </div>
        <h2
          class="text-3xl md:text-4xl font-extrabold text-[#0b1c3f] tracking-tight mb-6 leading-tight uppercase"
        >
          {{ siteSettings.profile_title }}
        </h2>
        <p
          class="text-slate-600 leading-relaxed mb-4 text-base"
          v-html="siteSettings.profile_desc_1"
        ></p>
        <p
          class="text-slate-600 leading-relaxed mb-0 text-base"
          v-html="siteSettings.profile_desc_2"
        ></p>
      </div>
      ...
      <div v-reveal class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 reveal delay-150">
        <!-- Visi Card -->
        <div
          class="relative p-8 rounded-2xl bg-[#0b1c3f] shadow-md hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-out cursor-pointer text-white flex flex-col"
        >
        ...
        <!-- Misi Card -->
        <div
          class="relative p-8 rounded-2xl bg-[#d21d1d] shadow-md hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-out cursor-pointer text-white flex flex-col"
        >
          <div class="flex items-start gap-4">
            <span class="text-4xl">🚀</span>
            <div>
      ...
      <div class="mb-16">
        <div class="text-center max-w-2xl mx-auto mb-10">
          <div
            class="inline-block px-4 py-1.5 bg-[#d21d1d]/10 text-[#d21d1d] text-xs font-bold uppercase tracking-wider rounded-full mb-3"
          >
            Mengapa Memilih Kami
          </div>
          <h2 class="text-2xl md:text-3xl font-bold text-[#0b1c3f] tracking-tight">
            Kelebihan Layanan CITRACon
          </h2>
          <p class="text-slate-500 text-sm mt-2">
            Komitmen mutu tinggi dan kepuasan pelanggan untuk setiap proyek Anda
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div
            v-reveal
            class="group relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-[#0b1c3f] via-[#1e1b4b] to-[#3b0764] shadow-md hover:shadow-lg hover:shadow-indigo-500/30 hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.97] transition-all duration-300 ease-out cursor-pointer text-center reveal"
          >
            <!-- Shine Reflection Effect -->
            <div
              class="absolute inset-0 w-[50%] h-full bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 -translate-x-[150%] group-hover:translate-x-[250%] transition-transform duration-1000 ease-out pointer-events-none z-10"
            ></div>

            <div
              class="text-3xl mb-4 transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12 inline-block relative z-20"
            >
              🏆
            </div>
            <h3 class="text-base font-bold text-white mb-2 uppercase tracking-wide relative z-20">
              Kualitas Terjamin
            </h3>
            <p class="text-xs text-slate-200 leading-relaxed relative z-20">
              Produk dibuat dengan material pilihan dan proses produksi yang terkontrol untuk
              memastikan mutu terbaik.
            </p>
          </div>
          ...
          <div
            v-reveal
            class="group relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-[#d21d1d] via-[#701a75] to-[#3b0764] shadow-md hover:shadow-lg hover:shadow-fuchsia-500/30 hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.97] transition-all duration-300 ease-out cursor-pointer text-center reveal delay-150"
          >
            <!-- Shine Reflection Effect -->
            <div
              class="absolute inset-0 w-[50%] h-full bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 -translate-x-[150%] group-hover:translate-x-[250%] transition-transform duration-1000 ease-out pointer-events-none z-10"
            ...
            <p class="text-xs text-rose-100 leading-relaxed relative z-20">
              Setiap produk diproduksi dengan standar ukuran yang akurat untuk hasil pemasangan yang
              optimal.
            </p>
          </div>
          ...
          <div
            v-reveal
            class="group relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-[#d97706] via-[#7c2d12] to-[#1e1b4b] shadow-md hover:shadow-lg hover:shadow-amber-500/30 hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.97] transition-all duration-300 ease-out cursor-pointer text-center reveal delay-300"
          >
            <!-- Shine Reflection Effect -->
            <div
              class="absolute inset-0 w-[50%] h-full bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 -translate-x-[150%] group-hover:translate-x-[250%] transition-transform duration-1000 ease-out pointer-events-none z-10"
            ...
            <p class="text-xs text-amber-50 leading-relaxed relative z-20">
              Menawarkan harga yang bersaing tanpa mengurangi kualitas produk.
            </p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div
            v-reveal
            class="group relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-[#0284c7] via-[#0f172a] to-[#1e1b4b] shadow-md hover:shadow-lg hover:shadow-cyan-500/30 hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.97] transition-all duration-300 ease-out cursor-pointer text-center reveal delay-450"
          >
            <!-- Shine Reflection Effect -->
            <div
              class="absolute inset-0 w-[50%] h-full bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 -translate-x-[150%] group-hover:translate-x-[250%] transition-transform duration-1000 ease-out pointer-events-none z-10"
            ...
            <p class="text-xs text-sky-50 leading-relaxed relative z-20">
              Didukung sistem distribusi yang baik agar produk sampai sesuai jadwal proyek.
            </p>
          </div>
          ...
          <div
            v-reveal
            class="group relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-[#059669] via-[#064e3b] to-[#1e1b4b] shadow-md hover:shadow-lg hover:shadow-emerald-500/30 hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.97] transition-all duration-300 ease-out cursor-pointer text-center reveal delay-600"
          >
            <!-- Shine Reflection Effect -->
            <div
              class="absolute inset-0 w-[50%] h-full bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 -translate-x-[150%] group-hover:translate-x-[250%] transition-transform duration-1000 ease-out pointer-events-none z-10"
            ...
            <p class="text-xs text-emerald-50 leading-relaxed relative z-20">
              Tim kami siap membantu konsultasi dan memberikan solusi sesuai kebutuhan pelanggan.
            </p>
          </div>
        </div>
      </div>
      ...
      <div id="produk" class="mb-16 pt-8">
        <div class="flex items-center justify-between mb-8">
          <div>
            <h2 class="text-2xl md:text-3xl font-bold text-[#0b1c3f] tracking-tight">
              Katalog Beton Precast
            </h2>
            <p class="text-slate-500 text-sm mt-1">Produk unggulan dengan standar mutu tinggi</p>
          </div>
          <div>
            <span
              class="px-3 py-1.5 bg-[#0b1c3f]/10 text-[#0b1c3f] font-bold text-xs uppercase rounded-full"
            >
              SNI Certified
            </span>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <!-- Dark Overlay -->
            <div
              class="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/75 to-slate-950/45 z-10"
            ></div>
            ...
            <div class="relative z-20 flex flex-col justify-between h-full flex-grow">
              <div>
                <div
                  class="w-12 h-12 text-white flex items-center justify-center text-xl mb-4 rounded-xl shadow-md bg-white/10 backdrop-blur-md border border-white/20"
                >
                  {{ product.icon }}
                </div>
                ...
                <div
                  v-if="product.specs"
                  class="inline-block px-2 py-0.5 rounded bg-white/10 border border-white/20 text-[10px] text-slate-300 font-semibold mb-2"
                >
                  {{ product.specs }}
                </div>
              </div>
              <div class="pt-4 border-t border-white/15">
                <router-link
                  ...
                  class="w-full text-xs bg-[#d21d1d] hover:bg-[#b21818] text-white font-bold py-2.5 rounded-full shadow-sm transition-all cursor-pointer text-center block no-underline"
                >
                  Detail
                </router-link>
              </div>
      ...
      <div id="galeri-kerja" class="mb-12">
        <div class="text-center max-w-2xl mx-auto mb-10">
          ...
          <p class="text-slate-500 text-sm mt-2">
            Kontribusi CITRACon dalam proyek infrastruktur berskala nasional
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div
            v-reveal
            v-for="(item, idx) in siteSettings.portfolio_items"
            :key="idx"
            :class="
              'group relative rounded-2xl overflow-hidden h-72 flex flex-col justify-end p-6 reveal shadow-sm hover:shadow-md transition-all duration-300 ' +
              (idx === 1 ? 'delay-150' : idx === 2 ? 'delay-300' : '')
            "
          >
            <div
              class="absolute inset-0 bg-cover bg-center group-hover:scale-105 transition-transform duration-500 opacity-90"
              :style="{ backgroundImage: 'url(' + item.image + ')' }"
            ></div>
            <div
              class="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/50 to-transparent z-10"
            ></div>
            <div class="relative z-20 text-white">
              <span
                :class="idx % 2 === 0 ? 'text-red-400' : 'text-blue-400'"
      ...
      <div
        id="tracon"
        v-reveal
        class="mb-12 reveal transition-all duration-300 text-slate-800 pt-4"
      >
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div class="lg:col-span-5 flex justify-center w-full">
            <div class="relative overflow-hidden rounded-2xl max-w-sm w-full group">
              ...
              <!-- Indicators -->
              <div
                class="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex gap-2 bg-black/40 backdrop-blur-sm px-3 py-1.5 rounded-full"
              >
                <span
          ...
          <div class="lg:col-span-7 space-y-6">
            <div>
              ...
              <h2 class="text-2xl md:text-3xl font-bold text-[#0b1c3f] tracking-tight uppercase">
                MEMPERKENALKAN TRACON
              </h2>
            ...
            <div class="flex border-b border-slate-100 gap-6">
              ...
              >
                Profil Maskot
                <span
                  v-if="activeMascotTab === 'profile'"
                  class="absolute bottom-0 left-0 right-0 h-0.5 bg-[#d21d1d]"
                ></span>
              </button>
              <button
              ...
              >
                Filosofi Visual
                <span
                  v-if="activeMascotTab === 'philosophy'"
                  class="absolute bottom-0 left-0 right-0 h-0.5 bg-[#d21d1d]"
                ></span>
              </button>
            </div>
            ...
            <div v-if="activeMascotTab === 'profile'" class="space-y-4 transition-all duration-300">
              <div
                v-for="(card, idx) in siteSettings.tracon_profile_cards"
                :key="idx"
                :class="
                  'p-4 rounded-xl text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all bg-gradient-to-br ' +
                  (idx === 0
                    ? 'from-[#0b1c3f] via-[#1e1b4b] to-[#3b0764]'
                    : idx === 1
                      ? 'from-[#d21d1d] via-[#701a75] to-[#3b0764]'
                      : 'from-[#059669] via-[#064e3b] to-[#1e1b4b]')
                "
              >
                <div>
                  <h4 class="font-bold text-white text-sm uppercase tracking-wide">
                    {{ card.title }}
                  </h4>
            ...
            <div v-else class="grid grid-cols-1 sm:grid-cols-3 gap-4 transition-all duration-300">
              <div
                v-for="(card, idx) in siteSettings.tracon_philosophy_cards"
                :key="idx"
                :class="
                  'p-4 rounded-xl text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all bg-gradient-to-br ' +
                  (idx === 0
              ...
              >
                ...
                <h4 class="font-bold text-xs uppercase tracking-wide text-white">
                  {{ card.title }}
                </h4>
      ...
      <div id="tracon-zone" v-reveal class="mb-12 reveal transition-all duration-300">
        <div
          class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#f8fafc] via-[#eff6ff] to-[#fef2f2] border border-slate-200/60 shadow-sm py-10 px-6 md:px-12"
        >
          <!-- Floating particle decorations -->
          <div
            class="absolute top-4 left-10 w-3 h-3 rounded-full bg-[#d21d1d]/20 animate-bounce"
            style="animation-delay: 0.2s"
          ></div>
          <div
            class="absolute top-10 right-16 w-4 h-4 rounded-full bg-[#0b1c3f]/10 animate-bounce"
            style="animation-delay: 0.8s"
          ></div>
          <div
            class="absolute bottom-8 left-20 w-2 h-2 rounded-full bg-emerald-400/30 animate-bounce"
            style="animation-delay: 0.5s"
          ></div>
          <div
            class="absolute bottom-4 right-8 w-3 h-3 rounded-full bg-[#d21d1d]/15 animate-bounce"
            style="animation-delay: 1.1s"
          ></div>
          <div
            class="absolute top-1/2 left-4 w-2 h-2 rounded-full bg-amber-400/30 animate-bounce"
          ...
          <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div class="lg:col-span-5 flex flex-col items-center justify-center gap-4">
              ...
              <div class="relative">
                <div
                  class="bg-white border-2 border-[#0b1c3f]/10 rounded-2xl px-5 py-3 shadow-md max-w-[240px] text-center mascot-bubble"
                >
                  <p
                    class="text-xs font-bold text-[#0b1c3f] leading-relaxed transition-all duration-500"
                  >
                ...
                <div
                  class="absolute -bottom-3 left-1/2 -translate-x-1/2 w-0 h-0"
                  style="
              ...
              <div
                class="mascot-bounce cursor-pointer select-none"
                @click="nextMascotSpeech"
                title="Klik untuk ngobrol!"
              >
                <img
                  :src="activeMascotImg"
                  alt="TRACON Mascot"
            ...
            <div class="lg:col-span-7 space-y-4">
              <div
                class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#0b1c3f]/10 text-[#0b1c3f] text-xs font-bold uppercase tracking-wider"
              >
                🤖 Sudut TRACON
              </div>
              <h3
                class="text-2xl md:text-3xl font-extrabold text-[#0b1c3f] tracking-tight uppercase leading-tight"
                v-html="
                  siteSettings.tracon_title ||
                  'Bertemu <span class=\'text-[#d21d1d]\'>TRACON</span>, Maskot CITRACon'
                "
              ></h3>
              <p class="text-slate-500 text-sm leading-relaxed">
                {{
                  siteSettings.tracon_desc ||
              ...
              <div class="grid grid-cols-3 gap-3 pt-2">
                <div
                  v-for="(stat, sIdx) in traconFunStats"
                  :key="sIdx"
                  class="text-center p-3 rounded-xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all"
                >
      ...
      <div
        id="klien"
        v-reveal
        class="rounded-3xl border border-slate-100 bg-white p-8 md:p-12 relative overflow-hidden mb-12 reveal transition-all duration-300 shadow-md text-slate-800 text-center"
      >
        <div class="max-w-3xl mx-auto mb-8">
          ...
          <p class="text-slate-500 text-sm mt-3 leading-relaxed">
            Kami bangga telah dipercaya oleh berbagai perusahaan kontraktor terkemuka dan instansi
            nasional untuk mendukung kesuksesan pembangunan infrastruktur di Indonesia.
          </p>
        </div>
        ...
        <div class="flex flex-wrap items-center justify-center gap-12 mt-6">
          ...
          >
            <img
              ...
              :src="client.image"
              :alt="client.name"
              class="max-h-12 w-auto object-contain transition-all duration-300 group-hover:scale-105"
            />
      ...
      <div
        id="kontak"
        v-reveal
        class="mb-16 reveal transition-all duration-300 text-slate-800 pt-8 border-t border-slate-200/50"
      >
        <div class="text-center max-w-xl mx-auto mb-10">
          <div
            class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#d21d1d]/10 text-[#d21d1d] text-xs font-bold uppercase tracking-wider mb-3"
          >
            ✉️ Hubungi Kami
          </div>
          <h2 class="text-2xl md:text-3xl font-bold text-[#0b1c3f] tracking-tight uppercase">
          ...
          <p class="text-slate-500 text-sm mt-3 leading-relaxed">
            Terhubung langsung dengan tim kami melalui layanan pelanggan resmi CITRACon di bawah
            ini.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto px-4">
          ...
          <div
            class="group relative overflow-hidden rounded-2xl bg-white border border-slate-200/60 p-6 shadow-sm hover:shadow-xl hover:shadow-emerald-500/30 hover:-translate-y-1 hover:border-emerald-500/50 transition-all duration-300 flex flex-col justify-between min-h-[220px]"
          >
            <div
              class="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-emerald-500/20 blur-xl pointer-events-none group-hover:bg-emerald-500/35 transition-all duration-300"
            ></div>
            <div>
              <div
                class="w-12 h-12 rounded-xl bg-emerald-500/20 text-emerald-600 flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300"
              >
                <q-icon name="chat" />
              </div>
              <h3 class="text-base font-extrabold text-[#0b1c3f] uppercase tracking-wide">
                WhatsApp Sales
              </h3>
          ...
          >
            <div
              class="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-pink-500/20 blur-xl pointer-events-none group-hover:bg-pink-500/35 transition-all duration-300"
            ></div>
            <div>
              <div
                class="w-12 h-12 rounded-xl bg-pink-500/20 text-pink-600 flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300"
              >
          ...
          <!-- Card 3: TikTok -->
          <a
            href="https://tiktok.com/@citraconbetonprecast"
            target="_blank"
          ...
          >
            <div
              class="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-cyan-500/20 blur-xl pointer-events-none group-hover:bg-cyan-500/35 transition-all duration-300"
            ></div>
            <div>
              <div
                class="w-12 h-12 rounded-xl bg-slate-900 text-white flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300"
              >
          ...
          >
            <div
              class="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-blue-500/20 blur-xl pointer-events-none group-hover:bg-blue-500/35 transition-all duration-300"
            ></div>
            <div>
              <div
                class="w-12 h-12 rounded-xl bg-blue-500/20 text-blue-600 flex items-center justify-center text-2xl mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300"
              >
                <q-icon name="mail" />
              </div>
              <h3 class="text-base font-extrabold text-[#0b1c3f] uppercase tracking-wide">
              ...
              <div class="text-[10px] font-bold text-[#0b1c3f] mt-2 truncate">
                citraelvanoberkah.adm@gmail.com
              </div>
            </div>
            <div
      ...
      >
        <div class="text-center max-w-xl mx-auto mb-10">
          ...
          <p class="text-slate-500 text-sm mt-3 leading-relaxed">
            Kami siap menyambut kunjungan Anda untuk meninjau secara langsung kualitas produksi
            precast di fasilitas pabrik modern kami.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div class="lg:col-span-5 flex flex-col justify-between space-y-6">
            <div
              class="p-6 rounded-2xl bg-white border border-slate-200/60 shadow-sm flex-grow flex flex-col justify-between space-y-6"
            >
              <q-list class="text-slate-600 q-pa-none space-y-6">
                ...
                <q-item class="q-px-none q-py-none items-start min-h-0">
                  ...
                  <q-item-section>
                    <q-item-label class="font-bold text-[#0b1c3f] text-base uppercase tracking-wide"
                      >Alamat Utama</q-item-label
                    >
                    <q-item-label class="text-sm text-slate-600 mt-1.5 leading-relaxed">
                      Jl. Tegal Danas No.18a, Sertajaya, Kec. Cikarang Tim., Kabupaten Bekasi, Jawa
                      Barat 17530
                    </q-item-label>
                  </q-item-section>
                </q-item>
                ...
                <q-item class="q-px-none q-py-none items-start min-h-0">
                  ...
                  <q-item-section>
                    <q-item-label class="font-bold text-[#0b1c3f] text-base uppercase tracking-wide"
                      >Kontak Layanan</q-item-label
                    >
                    <q-item-label class="text-sm text-slate-600 mt-1.5 leading-relaxed">
                      {{ siteSettings.contact_wa_1_label }}:
                      <a
                        :href="'https://wa.me/' + siteSettings.contact_wa_1_num"
                        target="_blank"
                        class="text-slate-600 hover:text-[#d21d1d] font-bold transition-all no-underline"
                        >{{ siteSettings.contact_wa_1_num }}</a
                      ><br />
                      {{ siteSettings.contact_wa_2_label }}:
                      <a
                        :href="'https://wa.me/' + siteSettings.contact_wa_2_num"
                        target="_blank"
                        class="text-slate-600 hover:text-[#d21d1d] font-bold transition-all no-underline"
                        >{{ siteSettings.contact_wa_2_num }}</a
                      ><br />
                      Sales 3:
                      <a
                        href="https://wa.me/6287848104524"
                        target="_blank"
                        class="text-slate-600 hover:text-[#d21d1d] font-bold transition-all no-underline"
                        >087848104524</a
                      ><br />
                      ...
                      <a
                        ...
                        class="text-[#0b1c3f] hover:text-[#d21d1d] font-semibold transition-all no-underline"
                        >{{ siteSettings.contact_email }}</a
                      >
                    </q-item-label>
                  </q-item-section>
                </q-item>
          ...
          <div class="lg:col-span-7 flex">
            <div
              class="w-full rounded-2xl border border-slate-200/60 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 bg-slate-50 flex items-stretch"
            >
      ...
      <div id="konsultasi" v-reveal class="mb-8 reveal transition-all duration-300">
        <div
          class="relative overflow-hidden rounded-3xl p-8 md:p-12 text-white bg-gradient-to-br from-[#0b1c3f] via-[#1e293b] to-[#7f1d1d] shadow-2xl border border-white/10"
        >
          <!-- Premium background decorative glowing shapes -->
          <div
            class="absolute -top-24 -right-24 w-80 h-80 rounded-full bg-[#d21d1d]/20 blur-[80px] pointer-events-none"
          ></div>
          <div
            class="absolute -bottom-24 -left-24 w-80 h-80 rounded-full bg-[#3b82f6]/10 blur-[80px] pointer-events-none"
          ></div>
          ...
          <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div class="lg:col-span-8 space-y-4">
              <div
                class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-[#fca5a5] text-xs font-bold uppercase tracking-wider"
              >
                💬 Konsultasi Proyek & Estimasi
              </div>
              <h3
                class="text-3xl md:text-4xl font-extrabold tracking-tight uppercase leading-tight"
              >
              ...
              <p class="text-slate-200 text-sm md:text-base leading-relaxed max-w-2xl">
                Butuh hitungan spesifikasi teknis saluran, kebutuhan box culvert, jalan beton, atau
                pagar panel? Tim spesialis insinyur CITRACon siap membantu memberikan analisis
                gratis & penawaran harga terbaik.
              </p>
            </div>
    ...
    <q-dialog v-model="showModal">
      <q-card
        class="bg-white text-slate-800 rounded-2xl border border-slate-100 p-6 shadow-2xl"
        style="min-width: 350px"
      >
        <q-card-section class="q-pt-none text-center">
          <div class="text-h6 text-[#d21d1d] font-bold mb-2">Mulai Konsultasi Citracon</div>
          <p class="text-slate-600 text-sm">
            Tim spesialis beton kami siap membantu menghitung spesifikasi detail konstruksi Anda.
          </p>
          <div class="space-y-4 mt-4 text-left">
            <div>
              ...
              <input
                ...
                type="text"
                class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 font-medium focus:outline-none focus:border-[#0b1c3f] focus:bg-white transition-all"
        ...
        <q-card-actions align="right" class="mt-4 gap-2">
          <button
            ...
            class="text-sm font-bold text-slate-400 hover:text-slate-600 px-4 py-2 uppercase transition-colors"
          >
            Batal
          </button>
          <button
            @click="submitLead"
            class="bg-[#d21d1d] hover:bg-[#b21818] text-white font-bold px-6 py-2.5 rounded-full shadow-md transition-all uppercase text-sm"
          >
            Hubungi Kami
          </button>
        </q-card-actions>
    ...
    <q-dialog v-model="showWhatsAppChoice">
      <q-card
        class="bg-[#0b1c3f] text-white rounded-2xl border border-white/10 p-6 shadow-2xl"
        style="min-width: 320px; max-width: 400px"
      >
        <q-card-section class="q-pt-none text-center relative overflow-hidden">
          <!-- Background glow -->
          <div
            class="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-[#d21d1d]/20 blur-[30px] pointer-events-none"
          ></div>

          <div class="text-h6 font-bold uppercase tracking-wider mb-2">Pilih WhatsApp Sales</div>
          <p class="text-slate-300 text-xs mb-6">
            Silakan pilih salah satu layanan WhatsApp Sales kami untuk konsultasi:
          </p>
          ...
          <div class="space-y-4">
            ...
            >
              <div
                class="w-10 h-10 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center font-bold"
              >
                <q-icon name="chat" size="20px" />
              </div>
              <div class="text-left">
                <div
                  class="text-sm font-bold text-white group-hover:text-[#d21d1d] transition-colors"
                >
                  {{ siteSettings.contact_wa_1_label || 'WhatsApp Sales 1' }}
                </div>
            ...
            >
              ...
              <div class="text-left">
                <div
                  class="text-sm font-bold text-white group-hover:text-[#d21d1d] transition-colors"
                >
                  {{ siteSettings.contact_wa_2_label || 'WhatsApp Sales 2' }}
                </div>
...
onMounted(() => {
  ...
  if (metaDesc) {
    metaDesc.setAttribute(
      'content',
      'Produsen Beton Precast & Beton Pracetak Mutu Tinggi SNI di Indonesia. Jual U-Ditch (Saluran Air), Pagar Panel Beton (Panel Pagar), Buis Beton, Kansten Jalan (Kanstin), Box Culvert, RCP.',
    )
  }
...
async function fetchSiteSettings() {
  ...
  if (error) {
    ...
    const waMsg = encodeURIComponent(
      'Halo Sales CITRACon, saya ingin bertanya mengenai produk beton precast.',
    )
...
function openWhatsAppWithChoice(customMessage = '') {
  ...
  const msg =
    customMessage || 'Halo Sales CITRACon, saya ingin bertanya mengenai produk beton precast.'
...
function prevMascotSlide() {
  activeMascotSlide.value =
    activeMascotSlide.value === 0 ? mascotImages.value.length - 1 : activeMascotSlide.value - 1
}

function nextMascotSlide() {
  activeMascotSlide.value =
    activeMascotSlide.value === mascotImages.value.length - 1 ? 0 : activeMascotSlide.value + 1
}
...
const traconspeech = computed(() => {
  if (
    ...
    siteSettings.value.tracon_speech_bubbles.length > 0
  ) {
